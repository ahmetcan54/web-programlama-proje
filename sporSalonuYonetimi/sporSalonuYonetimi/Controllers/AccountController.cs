...
namespace SporSalonuYonetimi.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Profile()
        {
            ...
            if (uye == null)
            {
                // Üye kaydı yoksa yeni bir üye oluştur
                uye = new Uye
                {
                    UserId = user.Id,
                    Ad = user.Ad ?? "",
                ...
                TempData["InfoMessage"] = "Hoş geldiniz! Lütfen profil bilgilerinizi tamamlayın.";
            }
        ...
        public async Task<IActionResult> UpdateProfile(Uye model)
        {
            ...
            _logger.LogInformation("Kullanıcı profili güncellendi: {UserId}", user.Id);
            TempData["SuccessMessage"] = "Profiliniz başarıyla güncellendi.";
