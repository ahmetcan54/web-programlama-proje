...
namespace SporSalonuYonetim.Controllers
{
    ...
    public class RandevuController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            if (uye == null)
            {
                TempData["ErrorMessage"] = "Üye profili bulunamadý.";
        ...
        public async Task<IActionResult> Create(RandevuViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (cakismaVar)
                {
                    ModelState.AddModelError("", "Seçilen saatte antrenörün baþka randevusu var.");
                    model.AntrenorListesi = await _context.Antrenorler.Where(a => a.Aktif).ToListAsync();
                    model.HizmetListesi = await _context.Hizmetler.Where(h => h.Aktif).ToListAsync();
                    return View(model);
                }
                ...
                _logger.LogInformation("Yeni randevu oluþturuldu: Üye {UyeId}, Antrenör {AntrenorId}", uye.Id, model.AntrenorId);
                TempData["SuccessMessage"] = "Randevu talebiniz oluþturuldu. Onay bekleniyor.";
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            // Sadece kendi randevularýný görebilir
            var user = await _userManager.GetUserAsync(User);
            var uye = await _context.Uyeler.FirstOrDefaultAsync(u => u.UserId == user.Id);
        ...
        public async Task<IActionResult> Approve(int id)
        {
            ...
            TempData["SuccessMessage"] = "Randevu onaylandý.";
