    ...
    public class AntrenorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Ad,Soyad,Email,Telefon,UzmanlikAlani,DeneyimYili,Biyografi,ProfilFotoUrl,Aktif,SporSalonuId")] Antrenor antrenor)
        {
            if (ModelState.IsValid)
            {
                ...
                if (emailExists)
                {
                    ModelState.AddModelError("Email", "Bu email adresi zaten kayýtlý.");
                ...
                _logger.LogInformation("Yeni antrenör oluþturuldu: {Ad} {Soyad}", antrenor.Ad, antrenor.Soyad);
                TempData["SuccessMessage"] = "Antrenör baþarýyla eklendi.";
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,Ad,Soyad,Email,Telefon,UzmanlikAlani,DeneyimYili,Biyografi,ProfilFotoUrl,Aktif,IseBaslamaTarihi,SporSalonuId")] Antrenor antrenor)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    TempData["SuccessMessage"] = "Antrenör bilgileri baþarýyla güncellendi.";
                }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (antrenor.Randevular != null && antrenor.Randevular.Any())
            {
                ...
                _context.Update(antrenor);
                TempData["InfoMessage"] = "Antrenör randevularý olduðu için devre dýþý býrakýldý.";
            }
            else
            {
                _context.Antrenorler.Remove(antrenor);
                TempData["SuccessMessage"] = "Antrenör baþarýyla silindi.";
            }

            await _context.SaveChangesAsync();
            _logger.LogInformation("Antrenör silindi/devre dýþý býrakýldý: {Id}", id);
